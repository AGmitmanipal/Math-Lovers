...
export default function LoginPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // 2. Sync / Create Session with Backend
            ...
            if (res.ok) {
                ...
                if (!user.emailVerified) {
                    // We could block here, but typically we let them login and then redirect
                    // The AuthContext/Middleware will handle the restriction
