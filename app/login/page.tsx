...
export default function LoginPage() {
    ...
    const handleGoogleLogin = async () => {
        ...
        try {
            ...
            // Get the Google ID Token, not the Firebase one
        ...
        <div className="flex items-center justify-center min-h-screen bg-white text-black">
            <div className="w-full max-w-md p-8 bg-white border border-gray-200">
                <div className="text-center mb-10">
                    ...
                    <p className="mt-2 text-gray-500">Sign in to solve doubts</p>
                </div>

                {error && (
                    <div className="mb-6 p-4 text-sm bg-gray-100 border border-black text-black">
                        {error}
                    </div>
                )}
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <button
                        ...
                        className="flex items-center justify-center w-full py-4 bg-white text-black font-bold uppercase tracking-widest border-2 border-black hover:bg-gray-50 transition-colors"
                    >
                ...
                <p className="mt-8 text-center text-sm text-gray-500">
                    New here?{' '}
                    <Link href="/signup" className="font-bold text-black border-b border-black pb-0.5 hover:text-gray-700">
                        Create an account
                    </Link>
                </p>
            </div>
